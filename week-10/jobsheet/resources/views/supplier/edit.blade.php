            ...
            <form action="{{ url('/supplier/' . $supplier->supplier_id) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="supplier_kode" id="supplier_kode" class="form-control" 
                        value="{{ $supplier->supplier_kode }}" readonly>
                </div>
                <div class="form-group">
                    ...
                    <input type="text" name="supplier_nama" id="supplier_nama" class="form-control" 
                        placeholder="Masukkan nama supplier" value="{{ old('supplier_nama', $supplier->supplier_nama) }}" required>
                    @error('supplier_nama')
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="supplier_telp" id="supplier_telp" class="form-control" 
                                placeholder="Masukkan nomor telepon" value="{{ old('supplier_telp', $supplier->supplier_telp) }}">
                            @error('supplier_telp')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="email" name="supplier_email" id="supplier_email" class="form-control" 
                                placeholder="Masukkan email supplier" value="{{ old('supplier_email', $supplier->supplier_email) }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="supplier_kontak" id="supplier_kontak" class="form-control" 
                        placeholder="Masukkan nama kontak person" value="{{ old('supplier_kontak', $supplier->supplier_kontak) }}">
