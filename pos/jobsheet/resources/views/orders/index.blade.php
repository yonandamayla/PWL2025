...
@section('content')
    <div class="container-fluid no-print">
        @if(isset($view) && $view == 'receipt')
            ...
            <div class="receipt-container real-receipt">
                    ...
                    <div class="receipt">
                        ...
                        <div class="order-info">
                            ...
                            <div><span class="label">Tanggal:</span>
                                {{ Carbon\Carbon::parse($order->order_date ?? $order->created_at)->format('d/m/Y H:i') }}</div>
                            ...
                            <tbody>
                                ...
                                @if($order->discount > 0)
                                    <tr>
                                        ...
                                        <td class="right">
                                            {{ number_format($order->total_price * $order->discount / 100, 0, ',', '.') }}</td>
                                    </tr>
                                @endif
                                <tr class="total-row">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="receipt-actions">
                                <a href="{{ route('orders.index', ['view' => 'receipt', 'order_id' => $order->id]) }}"
                                    class="btn btn-info">
