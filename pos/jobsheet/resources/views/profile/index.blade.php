        ...
        <div class="col-md-4 col-lg-3">
            <div class="card profile-card mb-4">
                <div class="card-body text-center pt-4 pb-4">
                    <div class="profile-image-container mb-3">
                        ...
                        <button type="button" class="change-photo-btn" data-toggle="modal" data-target="#changePhotoModal">
            ...
            <div class="card mb-4">
                ...
                <div class="list-group list-group-flush profile-menu">
                    <a href="#personal-info" class="list-group-item list-group-item-action active" data-toggle="tab">
                ...
                <form id="photoUploadForm" action="{{ route('profile.photo') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="text-center mb-4">
                        <div id="imagePreviewContainer" class="mb-3">
                            <img id="imagePreview" src="{{ auth()->user()->profile_picture ? asset(auth()->user()->profile_picture) : asset('images/default-avatar.png') }}" alt="Preview" class="img-fluid rounded-circle" style="width: 150px; height: 150px; object-fit: cover;">
                        </div>
