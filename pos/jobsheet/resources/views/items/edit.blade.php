                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control @error('price') is-invalid @enderror" 
                                                id="price" name="price" value="{{ old('price', $item->price) }}" min="0" required>
                                        </div>
                                        @error('price')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <small class="form-text text-muted">Format: jpg, jpeg, png. Maks: 2MB. Kosongkan jika tidak ingin mengubah foto.</small>
                                        @error('photo')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="text-center">
                                            <img id="preview" src="{{ $item->photo ? asset($item->photo) : asset('images/no-image.png') }}" 
