            ...
            <form action="{{ url('/barang/' . $barang->barang_id) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="barang_kode" id="barang_kode" class="form-control" 
                        value="{{ $barang->barang_kode }}" readonly>
                </div>
                <div class="form-group">
                    <label for="barang_nama">Nama Barang</label>
                    <input type="text" name="barang_nama" id="barang_nama" class="form-control" 
                        placeholder="Masukkan nama barang" value="{{ old('barang_nama', $barang->barang_nama) }}" required>
                    @error('barang_nama')
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="harga_beli" id="harga_beli" class="form-control" 
                                    placeholder="Masukkan harga beli" value="{{ old('harga_beli', $barang->harga_beli) }}" required>
                            </div>
                            @error('harga_beli')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="harga_jual" id="harga_jual" class="form-control" 
                                    placeholder="Masukkan harga jual" value="{{ old('harga_jual', $barang->harga_jual) }}" required>
                            </div>
                            @error('harga_jual')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
