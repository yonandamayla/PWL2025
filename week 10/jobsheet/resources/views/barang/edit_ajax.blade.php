                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="barang_kode" id="barang_kode" 
                               value="{{ $barang->barang_kode }}" class="form-control" required>
                        <small id="error-barang_kode" class="error-text form-text text-danger"></small>
                    </div>
                    <div class="form-group">
                        <label>Barang Nama</label>
                        <input type="text" name="barang_nama" id="barang_nama" 
                               value="{{ $barang->barang_nama }}" class="form-control" required>
                        <small id="error-barang_nama" class="error-text form-text text-danger"></small>
                    </div>
                    <div class="form-group">
                        <label>Harga Beli</label>
                        <input type="number" name="harga_beli" id="harga_beli" 
                               value="{{ $barang->harga_beli }}" class="form-control" required>
                        <small id="error-harga_beli" class="error-text form-text text-danger"></small>
                    </div>
                    <div class="form-group">
                        <label>Harga Jual</label>
                        <input type="number" name="harga_jual" id="harga_jual" 
                               value="{{ $barang->harga_jual }}" class="form-control" required>
